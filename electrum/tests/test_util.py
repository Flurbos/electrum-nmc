...
class TestUtil(SequentialTestCase):
    ...
    def test_parse_URI_address(self):
        self._do_test_parse_URI('unobtanium:uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9',
                                {'address': 'uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9'})

    def test_parse_URI_only_address(self):
        self._do_test_parse_URI('uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9',
                                {'address': 'uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9'})


    def test_parse_URI_address_label(self):
        self._do_test_parse_URI('unobtanium:uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9?label=electrum%20test',
                                {'address': 'uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9', 'label': 'electrum test'})

    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('unobtanium:uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9?message=electrum%20test',
                                {'address': 'uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9', 'message': 'electrum test', 'memo': 'electrum test'})

    def test_parse_URI_address_amount(self):
        self._do_test_parse_URI('unobtanium:uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9?amount=0.0003',
                                {'address': 'uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9', 'amount': 30000})

    def test_parse_URI_address_request_url(self):
        self._do_test_parse_URI('unobtanium:uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'address': 'uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9', 'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_ignore_args(self):
        self._do_test_parse_URI('unobtanium:uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9?test=test',
                                {'address': 'uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9', 'test': 'test'})

    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('unobtanium:uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9?amount=0.00004&label=electrum-test&message=electrum%20test&test=none&r=http://domain.tld/page',
                                {'address': 'uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9', 'amount': 4000, 'label': 'electrum-test', 'message': u'electrum test', 'memo': u'electrum test', 'r': 'http://domain.tld/page', 'test': 'none'})

    def test_parse_URI_no_address_request_url(self):
        self._do_test_parse_URI('unobtanium:?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_invalid_address(self):
        self.assertRaises(BaseException, parse_URI, 'unobtanium:invalidaddress')

    def test_parse_URI_invalid(self):
        self.assertRaises(BaseException, parse_URI, 'notunobtanium:uKC4JyjyGGxbS2eC8jgZgLx5DkmwHxApj9')
